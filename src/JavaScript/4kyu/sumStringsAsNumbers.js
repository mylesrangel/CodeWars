...
function sumStrings(a,b) { 
    ...
    //if a.length || b.length is bigger than 10 we may end up with a scientific notation so we need to break it down
    if(a.length>=10 || b.length >=10){
        ...
        while((aLength >= 0 ) || (bLength >= 0)){
            ...
            //add up the both strings into a value
            if(a[aLength-1] && aLength > 0){
                currentValue += parseInt(a[aLength-1]);
            }
            if(b[bLength-1] && bLength > 0){
                currentValue += parseInt(b[bLength-1]);
            }
            if(overFlowValue > 0){
                currentValue += overFlowValue;
                overFlowValue = 0;
            }
            
            //if the current value is greater than 10, we need to add overflow
            if(currentValue > 9){
        ...
        //if the first value is 0 remove it
        if(newValue[0] == 0){
            newValue.shift();
        }
        //if both arrays are empty but overFlowValue isn't add overflow value to newValue
        if(overFlowValue > 0){
            newValue.unshift(overFlowValue);
        }
...
//console.log(sumStrings('48293829183922', '82340298422217') '130634127606139');
...
//console.log(sumStrings('712569312664357328695151392', '8100824045303269669937'), '131151201344081895336534324866')
...
//ACTUAL BigInt CLASS WITH FUNCTION CALL (NOTE: HAS ALL OPERATIORS (+ , - , *, /...etc...)
